...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Forecast> forecasts) : _forecasts = forecasts;
  ...
  @override
  String toString() {
    return 'ForecastState.loaded(forecasts: $forecasts)';
  }
...
abstract class _Loaded implements ForecastState {
  const factory _Loaded(final List<Forecast> forecasts) = _$LoadedImpl;
