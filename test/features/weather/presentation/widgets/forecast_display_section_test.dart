...
void main() {
  testWidgets('ForecastDisplaySection renders', (WidgetTester tester) async {
    await tester.pumpWidget(
      ...
      ], child: MaterialApp(home: Scaffold(body: ForecastDisplaySection()))),
    );
    expect(find.byType(ForecastDisplaySection), findsOneWidget);
    // By default, should render nothing (SizedBox.shrink)
